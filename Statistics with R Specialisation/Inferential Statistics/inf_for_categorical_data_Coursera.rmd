...
```{r us-atheism}
us12 <- atheism %>%
  filter(atheism$nationality == 'United States', atheism$year == '2012')
```
...
inference(y = response, x = year, data = spain, type = 'ht', statistic = 'proportion', success = 'atheist', method = 'theoretical', alternative = 'twosided')
```
...
inference(data = us, y = response, x = year, type = 'ht', statistic = 'proportion', method = 'theoretical', success = 'atheist', alternative = 'twosided')
```
